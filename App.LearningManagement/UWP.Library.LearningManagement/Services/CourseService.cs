...
namespace Library.LearningManagement.Services
{
    public class CourseService
    {
        ...
        public CourseService()
        {
            ...
            {
                new Course {Code = "COP4870", Name = "Full-Stack Application Development with C#", Description = "Fun Programming 1", CreditHours = 4, Room = "102C", Semester = {Season = SeasonEnum.Spring, Year = YearEnum.Year_2024} },
                ...
                new Course { Code = "COP434254", Name = "UNIX TOOLS1", Description = "Fun Programming 3", Room = "102C", CreditHours = 4, Semester = {Season = SeasonEnum.Spring, Year = YearEnum.Year_2024} },
